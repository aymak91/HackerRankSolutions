// A palindrome is a string which reads the same forward and backwards, for example, tacocat and mom. A string is a 
// scatter-palindrome if its letters can be rearranged to form a palindrome. Given an array consisting of n strings, 
// for each string, determine how many of its substrings are scatter-palindromes. A substring is a contiguous range 
...
function scatterPalindrome(strToEvaluate) {
    ...
    // strToEvaluate, individual string * 2
